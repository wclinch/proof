      ...
      <main style={{ flex: 1, maxWidth: '580px', width: '100%', margin: '0 auto', padding: '56px 20px', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ padding: '20px 0', borderBottom: '1px solid #1a1a1a', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#777', lineHeight: 1.75, margin: 0 }}>
            Your files never leave your device. If you sign in, your workspace structure, notes, URL references, and draft text sync to our servers. We collect your email and anonymized usage events. No file content is ever transmitted.
          </p>
        </div>
        ...
        <div style={{ padding: '20px 0', borderBottom: '1px solid #1a1a1a', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#777', lineHeight: 1.75, margin: 0 }}>
            PDF and image files are stored in your browser (IndexedDB) and are never uploaded to any server. They don't leave your machine under any circumstances. Notes and URL references are part of your workspace data and sync if you're signed in.
          </p>
        </div>
        ...
        <div style={{ padding: '20px 0', borderBottom: '1px solid #1a1a1a', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#777', lineHeight: 1.75, margin: 0 }}>
            When you create an account, your workspace names, source names, notes, URL references, and draft text are saved to our database so they're accessible on any device. This data is tied to your account and is never shared or sold. PDF and image files must be re-added on each device. Without an account, everything stays local.
          </p>
        </div>
